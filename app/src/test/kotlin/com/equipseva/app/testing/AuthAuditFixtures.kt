 ...
 *
 *  - [confirmedProfile]: a normalised confirmed profile with `role_confirmed =
 *    true` and aligned scalar, membership, and active roles. This is a test
 *    state, not a claim that each role RPC independently produces every field.
