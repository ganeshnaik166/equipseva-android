...
class MoneyTest {
    ...
    @Test fun `formatRupeesPaise shows two decimals with Indian grouping`() {
        org.junit.Assert.assertEquals("₹1,003.00", formatRupeesPaise(1003.0))
        org.junit.Assert.assertEquals("₹76.50", formatRupeesPaise(76.5))
        org.junit.Assert.assertEquals("₹1,00,000.00", formatRupeesPaise(100000.0))
    }
    ...
    @Test fun `formatRupeesPaise line items reconcile (why it exists)`() {
        ...
        // ₹76.50 + ₹76.50 == ₹153.00.
        org.junit.Assert.assertEquals("₹76.50", formatRupeesPaise(76.5))
        org.junit.Assert.assertEquals("₹153.00", formatRupeesPaise(153.0))
    }

    @Test fun `formatRupeesPaise handles paise carry and negatives`() {
        org.junit.Assert.assertEquals("₹77.00", formatRupeesPaise(76.999))
        org.junit.Assert.assertEquals("-₹12.34", formatRupeesPaise(-12.34))
    }
}
