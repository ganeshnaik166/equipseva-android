...
data class SparePart(
    ...
    val compatibleEquipmentCategories: List<String>,
...
internal fun SparePartDto.toDomain(): SparePart {
    ...
    return SparePart(
        ...
        compatibleBrands = compatibleBrands.orEmpty(),
        compatibleModels = compatibleModels.orEmpty(),
        compatibleEquipmentCategories = compatibleEquipmentCategories.orEmpty(),
        priceRupees = price,
        mrpRupees = mrp,
