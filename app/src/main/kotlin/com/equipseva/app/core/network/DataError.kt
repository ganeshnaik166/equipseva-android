...
private fun friendlyRestMessage(ex: RestException): String? {
    ...
    return when {
        ...
        // Phone-uniqueness has its own constraint name; surface specific copy
        // so users know to enter a different number rather than reading
        // "duplicate value" cold. supabase-kt's RestException.message wraps
        // the Postgrest JSON body — the 23505 SQLSTATE is rarely included
        // verbatim, so match the human-readable phrases too.
