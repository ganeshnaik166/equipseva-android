...
enum class RepairEquipmentCategory(val storageKey: String, val displayName: String) {
    ...
    companion object {
         ...
         * Screens with network access refresh the live list (see
         * CodeRedRepository.allowedEquipmentTypes); this static mirror is
         * the offline-safe fallback and must be kept in sync with the seed.
         */
