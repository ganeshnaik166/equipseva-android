...
data class SparePartDto(
    ...
    @SerialName("compatible_brands") val compatibleBrands: List<String> = emptyList(),
    @SerialName("compatible_models") val compatibleModels: List<String> = emptyList(),
    @SerialName("compatible_equipment_categories") val compatibleEquipmentCategories: List<String> = emptyList(),
    val price: Double,
    val mrp: Double? = null,
