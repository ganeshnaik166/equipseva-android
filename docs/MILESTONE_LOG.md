...
- Synced the owner's 23 September English-only main documentation into this candidate without changing app source. Next: save/push this branch, publish safe continuity docs separately, then begin an independently owned P1c token-capture slice. Do not merge the broad app candidate to main or claim production release.
