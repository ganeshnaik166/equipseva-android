...
- Synced the owner's 23 September English-only main documentation into this candidate without changing app source. The candidate checkpoint is pushed; `codex/docs-p1b-continuity-20260926` proposes these six safe continuity records separately. Next: an independently owned P1c token-capture slice. Do not merge the broad app candidate to main or claim production release.
