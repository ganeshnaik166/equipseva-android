...
| P3.1 | Three-choice entry and returning-user workspace selection | Planned | Existing two-persona live root only; [PR1889](https://github.com/ganeshnaik166/equipseva-android/pull/1889) signup navigation, [PR1888](https://github.com/ganeshnaik166/equipseva-android/pull/1888) Welcome accessibility and [PR1890](https://github.com/ganeshnaik166/equipseva-android/pull/1890) Sign in recovery target merged on main. Isolated SignUp footer target `ec423858` passed local 2,915/0 full, lint/debug/unsigned R8 and scoped critic/QA 9.6 each | Footer integration/CI pending; new org entry and full three-choice flow absent | Native auth/provider recovery; no paid/global-role shortcut; footer combined checks, hosted CI, device/TalkBack and signed-release gates |
...
| P7.1 | Remaining account/chat/AMC/admin redesign | Full page carry-forward map | Partial reusable components/legacy screens; Welcome `9abd0ffc` passed 5/0 focused, 2,912/0 local full and combined nav 10/0, design lint/lint/debug/unsigned R8; scoped critic/QA 9.7/9.6, combined 9.6/9.6. Separate SignIn recovery target `ffbc930f` has RED 3/2, GREEN 3/0, full 2,910/0 and scoped critic 9.7/QA 9.6 | Welcome [PR1888](https://github.com/ganeshnaik166/equipseva-android/pull/1888) merged main `afe2bd33` after all applicable CI; SignIn branch remains candidate; wider UI partial | SignIn hosted CI/main, physical TalkBack/device, hosted reset, affected runtime flows (English only); three-purpose entry and Space Grotesk/Inter remain open |
