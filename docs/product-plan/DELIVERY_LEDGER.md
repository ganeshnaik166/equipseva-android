...
| P1.3 | Safe owner/workspace queue, photos, caches and push | Architecture mapped; [P1d source gap](../helper-reviews/codex-20260926/p1d-remote-token-gap.md) and [security critique](../helper-reviews/codex-20260926/p1d-contract-critic.md) | Partial local P1a–P1c protections; P1d-0 sender payload/error-classification and CI locally verified 13/13 Node plus both Deno versions, scoped helper critic/QA 9.6 each, integration critic 9.6, preliminary QA 9.6. Tracked `device_tokens` DELETE revoke conflicts with client DELETE-before-upsert; live grants unknown | Sender-only PR checks pending; Android candidate and remote claim/release blocked | Actual DB schema, narrow versioned claim/release, concurrent races, old-client rollout, delayed producers/readers, process death, revocation, reconnect and provider/device privacy |
