...
| P3.1 | Three-choice entry and returning-user workspace selection | Planned | Existing two-persona live root only; separate signup-footer nav WIP `88f136d1` passes 2,912 unit tests and lint for its narrow path, pending final review | New org entry absent; nav WIP unmerged | Native auth/provider recovery; no paid/global-role shortcut |
