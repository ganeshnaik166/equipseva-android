...
| P3.1 | Three-choice entry and returning-user workspace selection | Planned | Existing two-persona live root only; the N01 chooser composable is prepared and tested on `claudedev-build-20260923` (`85fbb27e`, unwired, grants nothing) | New org entry absent; chooser not routed | Native auth/provider recovery; no paid/global-role shortcut; P2 tenant contracts before wiring |
