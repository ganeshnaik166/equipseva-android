...
| P3.1 | Three-choice entry and returning-user workspace selection | Planned | Existing two-persona live root only. Signup-footer navigation `88f136d1` and independent 48dp/compact-font footer candidate `ec423858` have scoped local tests; latter 2,915/0 full, lint/debug/unsigned release green, critic/QA pending | Nav [PR1889](https://github.com/ganeshnaik166/equipseva-android/pull/1889) merged at `edae85ed`; footer candidate unmerged; new org entry absent | Native auth/provider recovery; no paid/global-role shortcut; footer hosted CI/device/TalkBack/independent review |
