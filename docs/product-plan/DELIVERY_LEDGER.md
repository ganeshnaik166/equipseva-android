...
| P1.3 | Safe owner/workspace queue, photos, caches and push | Architecture mapped; [P1d source gap](../helper-reviews/codex-20260926/p1d-remote-token-gap.md) and [security critique](../helper-reviews/codex-20260926/p1d-contract-critic.md) | Partial local P1a–P1c protections; P1d-0 sender-only WIP at `85b91ddd` has synthetic Node and Deno 1.46/2.9 **13/0**, both Deno versions pass function check and full touched-file lint for generic visible push, bounded routing data, precise FCM errors and no token-only reap; [handoff](../HANDOFF_P1D0_SENDER_PRIVACY_2026-09-26.md). Critic/QA/device/Supabase deploy pending. Tracked `device_tokens` DELETE revoke still conflicts with client DELETE-before-upsert; live grants unknown | New remote claim/release and sender contract not integrated; app candidate remains blocked | Independent review and provider/device pilot for P1d-0; actual DB schema, narrow versioned claim/release/reap, concurrent races, old-client rollout, delayed producers/readers, process death, revocation, reconnect and provider/device privacy |
