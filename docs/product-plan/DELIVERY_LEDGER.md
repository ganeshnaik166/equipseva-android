...
| P1.2 | Cancelled logout/account restoration retires stale work | Planned; existing S3 finding | Partial. A3-01 exported-extra syntax policy is WIP on `codex/deeplink-extra-policy-20260926`; original behavioral RED 4/3, new safe-inbox fallback tests unrun, provisional critic 9.2 only | Blocked candidate; no A3 app merge | Root/session/router integration, logout and same-ID relogin; A3-02 cross-account buffered replay, role/recipient authorization, local GREEN/full, independent critic/QA and CI |
