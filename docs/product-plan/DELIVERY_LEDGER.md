...
| P1.3 | Safe owner/workspace queue, photos, caches and push | Architecture mapped; [P1d source gap](../helper-reviews/codex-20260926/p1d-remote-token-gap.md) and [security critique](../helper-reviews/codex-20260926/p1d-contract-critic.md) | Partial local P1a–P1c protections; P1d-0 sender payload/error-classification and CI locally verified 13/13 Node plus both Deno versions, scoped helper critic/QA 9.6 each, integration critic/QA 9.6 each. Tracked `device_tokens` DELETE revoke conflicts with client DELETE-before-upsert; live grants unknown | PR1886 sender CI and secret scans green at initial head; broader Android CI running at this record. Android candidate and remote claim/release blocked | Actual DB schema, narrow versioned claim/release, concurrent races, old-client rollout, delayed producers/readers, process death, revocation, reconnect and provider/device privacy |
