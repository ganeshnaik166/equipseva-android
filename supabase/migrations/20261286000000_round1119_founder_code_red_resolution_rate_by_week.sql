BEGIN;
DROP FUNCTION IF EXISTS public.founder_code_red_resolution_rate_by_week();
CREATE OR REPLACE FUNCTION public.founder_code_red_resolution_rate_by_week()
RETURNS TABLE (
  week_start         date,
  total              bigint,
  resolved           bigint,
...
END;
$$;
REVOKE EXECUTE ON FUNCTION public.founder_code_red_resolution_rate_by_week() FROM PUBLIC, anon;
GRANT  EXECUTE ON FUNCTION public.founder_code_red_resolution_rate_by_week() TO authenticated;
COMMIT;
