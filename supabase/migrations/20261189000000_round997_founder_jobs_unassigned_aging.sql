BEGIN;
DROP FUNCTION IF EXISTS public.founder_jobs_unassigned_aging();
...
END;
$$;
REVOKE EXECUTE ON FUNCTION public.founder_jobs_unassigned_aging() FROM PUBLIC, anon;
GRANT  EXECUTE ON FUNCTION public.founder_jobs_unassigned_aging() TO authenticated;
COMMIT;
