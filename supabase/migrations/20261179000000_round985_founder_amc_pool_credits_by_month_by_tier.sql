BEGIN;
DROP FUNCTION IF EXISTS public.founder_amc_pool_credits_by_month_by_tier();
CREATE OR REPLACE FUNCTION public.founder_amc_pool_credits_by_month_by_tier()
RETURNS TABLE (
  month_ist  date,
  tier       text,
  credits    bigint,
...
END;
$$;
REVOKE EXECUTE ON FUNCTION public.founder_amc_pool_credits_by_month_by_tier() FROM PUBLIC, anon;
GRANT  EXECUTE ON FUNCTION public.founder_amc_pool_credits_by_month_by_tier() TO authenticated;
COMMIT;
