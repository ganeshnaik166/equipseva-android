BEGIN;
DROP FUNCTION IF EXISTS public.founder_amc_by_city();
CREATE OR REPLACE FUNCTION public.founder_amc_by_city()
RETURNS TABLE (
  city                text,
  total_amcs          bigint,
  active              bigint,
...
END;
$$;
REVOKE EXECUTE ON FUNCTION public.founder_amc_by_city() FROM PUBLIC, anon;
GRANT  EXECUTE ON FUNCTION public.founder_amc_by_city() TO authenticated;
COMMIT;
