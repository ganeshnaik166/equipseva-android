BEGIN;
DROP FUNCTION IF EXISTS public.founder_top_engineers_90d();
...
END;
$$;
REVOKE EXECUTE ON FUNCTION public.founder_top_engineers_90d() FROM PUBLIC, anon;
GRANT  EXECUTE ON FUNCTION public.founder_top_engineers_90d() TO authenticated;
COMMIT;
