...
export default async function Page() {
  ...
  const [
    ...
    supabase.rpc('founder_r3438_qc_verdict_rollup'),
    supabase.rpc('founder_r3438_device_model_scorecard'),
    supabase.rpc('founder_r3438_parameter_verdict_matrix'),
    supabase.rpc('founder_r3438_monthly_calibration_trend'),
    supabase.rpc('founder_r3438_capa_status_board'),
    supabase.rpc('founder_r3438_root_cause_pareto'),
    supabase.rpc('founder_r3438_accuracy_impact_digest'),
    supabase.rpc('founder_r3438_high_risk_queue'),
  ]);
  ...
  return (
    <main style={{ padding: '2rem', maxWidth: 1400, margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>
        Bispectral-Index (BIS) / Depth-of-Anesthesia Monitor QC Audit
      </h1>
      <p style={{ color: '#555', marginBottom: '2rem' }}>
        Hospital BIS / processed-EEG depth-of-anesthesia monitor QA log — parameter (BIS index, EMG dB,
        signal-quality index, suppression ratio, burst count) &times; device model &times; reference
        &amp; measured value &times; deviation % &times; sensor lot &times; tolerance band &times;
        calibration date &amp; CAPA closure. Founder-gated view: QC verdicts, device-model scorecards,
        accuracy-impact digest, root-cause pareto and out-of-tolerance queue across NABH &amp; CDSCO
        surfaces.
      </p>
