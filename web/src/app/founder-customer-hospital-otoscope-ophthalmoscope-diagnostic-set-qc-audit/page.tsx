...
export default async function Page() {
  ...
  const [
    ...
    supabase.rpc('founder_r3503_qc_verdict_rollup'),
    supabase.rpc('founder_r3503_device_model_scorecard'),
    supabase.rpc('founder_r3503_parameter_verdict_matrix'),
    supabase.rpc('founder_r3503_monthly_calibration_trend'),
    supabase.rpc('founder_r3503_capa_status_board'),
    supabase.rpc('founder_r3503_root_cause_pareto'),
    supabase.rpc('founder_r3503_accuracy_impact_digest'),
    supabase.rpc('founder_r3503_high_risk_queue'),
  ]);
  ...
  return (
    <main style={{ padding: '2rem', maxWidth: 1400, margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>
        Otoscope / Ophthalmoscope Diagnostic-Set QC Audit
      </h1>
      <p style={{ color: '#555', marginBottom: '2rem' }}>
        Hospital otoscope &amp; ophthalmoscope diagnostic-set QA log — device model &times; parameter
        (light output lux, color temperature K, optical clarity, battery voltage, aperture alignment,
        lens focus) &times; reference vs measured &times; deviation % &times; tolerance &times;
