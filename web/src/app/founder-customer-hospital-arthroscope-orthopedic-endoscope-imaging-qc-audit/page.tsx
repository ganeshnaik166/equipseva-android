...
export default async function Page() {
  ...
  const [
    ...
    supabase.rpc('founder_r3543_qc_verdict_rollup'),
    supabase.rpc('founder_r3543_device_model_scorecard'),
    supabase.rpc('founder_r3543_parameter_verdict_matrix'),
    supabase.rpc('founder_r3543_monthly_calibration_trend'),
    supabase.rpc('founder_r3543_capa_status_board'),
    supabase.rpc('founder_r3543_root_cause_pareto'),
    supabase.rpc('founder_r3543_accuracy_impact_digest'),
    supabase.rpc('founder_r3543_high_risk_queue'),
  ]);
  ...
  return (
    <main style={{ padding: '2rem', maxWidth: 1400, margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>
        Arthroscope (Orthopedic Endoscope) Imaging QC Audit
      </h1>
      <p style={{ color: '#555', marginBottom: '2rem' }}>
        Orthopedic arthroscope imaging QA log &mdash; device model &times; unit &times; parameter
        (image resolution, light transmission, viewing angle, color fidelity, focus clarity &amp;
        seal-leak test) &times; reference vs measured &times; deviation % &times; within-tolerance
