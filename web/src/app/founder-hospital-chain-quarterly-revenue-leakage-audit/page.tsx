...
export default async function Page() {
  ...
  const leakageCols: Column<any>[] = [
    ...
    { key: 'leakage_rupees', header: 'Rupees', render: (r: any) => `Rs ${Number(r.leakage_rupees ?? 0).toLocaleString('en-IN')}` },
  ...
  const kindCols: Column<any>[] = [
    ...
    { key: 'total_rupees', header: 'Total Rupees', render: (r: any) => `Rs ${Number(r.total_rupees ?? 0).toLocaleString('en-IN')}` },
  ];

  const statusCols: Column<any>[] = [
    { key: 'status', header: 'Status', render: (r: any) => r.status },
    { key: 'leakage_count', header: 'Count', render: (r: any) => String(r.leakage_count) },
    { key: 'total_rupees', header: 'Rupees', render: (r: any) => `Rs ${Number(r.total_rupees ?? 0).toLocaleString('en-IN')}` },
  ];
  ...
  const summaryCols: Column<any>[] = [
    ...
    { key: 'open_rupees', header: 'Open + Review', render: (r: any) => `Rs ${Number(r.open_rupees ?? 0).toLocaleString('en-IN')}` },
    { key: 'recovered_rupees', header: 'Recovered', render: (r: any) => `Rs ${Number(r.recovered_rupees ?? 0).toLocaleString('en-IN')}` },
  ];
