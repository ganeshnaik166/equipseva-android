...
export default async function Page() {
  ...
  const [
    ...
    supabase.rpc('founder_r3591_qc_verdict_rollup'),
    supabase.rpc('founder_r3591_device_model_scorecard'),
    supabase.rpc('founder_r3591_parameter_verdict_matrix'),
    supabase.rpc('founder_r3591_monthly_calibration_trend'),
    supabase.rpc('founder_r3591_capa_status_board'),
    supabase.rpc('founder_r3591_root_cause_pareto'),
    supabase.rpc('founder_r3591_accuracy_impact_digest'),
    supabase.rpc('founder_r3591_high_risk_queue'),
  ]);
  ...
  const riskCols: Column<RiskRow>[] = [
    ...
    { key: 'within_tolerance', header: 'Tolerance' },
  ...
  return (
    <main style={{ padding: '2rem', maxWidth: 1400, margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>
        Bone-Growth Stimulator (PEMF / LIPUS) QC Audit
      </h1>
      <p style={{ color: '#555', marginBottom: '2rem' }}>
        Hospital bone-growth stimulator QA log — PEMF magnetic-field &amp; LIPUS ultrasound devices
        &times; parameter (field strength gauss, output current mA, LIPUS intensity mW/cm&sup2;,
        frequency kHz, treatment-timer accuracy, waveform integrity) &times; reference vs measured
        &times; deviation &times; tolerance &times; calibration date &times; QC verdict &amp; CAPA
