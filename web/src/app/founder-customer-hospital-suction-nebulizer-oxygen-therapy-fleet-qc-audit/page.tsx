...
type MatrixRow = {
  ...
  avg_oxygen_purity_pct: number | null;
};
type TrendRow = {
  check_date: string;
  checks: number;
...
type RiskRow = {
  ...
  check_date: string;
  qc_verdict: string;
  vacuum_pressure_accuracy_ok: string | null;
...
export default async function Page() {
  ...
  const [
    ...
    supabase.rpc('founder_r3363_qc_verdict_rollup'),
    supabase.rpc('founder_r3363_hospital_scorecard'),
    supabase.rpc('founder_r3363_device_type_ward_matrix'),
    supabase.rpc('founder_r3363_daily_qc_trend'),
    supabase.rpc('founder_r3363_capa_status_board'),
    supabase.rpc('founder_r3363_root_cause_pareto'),
    supabase.rpc('founder_r3363_regulatory_impact_digest'),
    supabase.rpc('founder_r3363_high_risk_queue'),
  ]);
  ...
  const hospCols: Column<HospRow>[] = [
    ...
    { key: 'vacuum_fail', header: 'Vacuum Fail' },
    { key: 'alarm_fail', header: 'Alarm Fail' },
    { key: 'filter_issue', header: 'Filter Issue' },
  ...
  const matrixCols: Column<MatrixRow>[] = [
    ...
    { key: 'avg_oxygen_purity_pct', header: 'Avg O2 Purity %' },
  ];
  ...
  const riskCols: Column<RiskRow>[] = [
    ...
    { key: 'check_date', header: 'Date' },
    { key: 'qc_verdict', header: 'Verdict' },
    { key: 'vacuum_pressure_accuracy_ok', header: 'Vacuum' },
  ...
  return (
    <main style={{ padding: '2rem', maxWidth: 1400, margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>
        Customer Hospital Suction, Nebulizer &amp; Oxygen-Therapy Device Fleet QC Audit
      </h1>
      <p style={{ color: '#555', marginBottom: '2rem' }}>
        Respiratory-support QA log — device type &times; ward &times; vacuum-pressure accuracy
        &times; flow-rate error % &times; oxygen purity % &times; filter condition &times; canister
        seal &times; alarm test &times; tubing hygiene &times; calibration currency &amp; CAPA
