...
import { revokeReferralBounty } from "@/app/actions/referrals";

export function RevokeBountyButton({ referralId }: { referralId: string }) {
  ...
  function trigger() {
    ...
    startTransition(async () => {
      ...
      const res = await revokeReferralBounty(referralId, reason.trim());
