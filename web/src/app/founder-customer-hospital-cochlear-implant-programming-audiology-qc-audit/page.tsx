...
export default async function Page() {
  ...
  const [
    ...
    supabase.rpc('founder_r3579_qc_verdict_rollup'),
    supabase.rpc('founder_r3579_device_model_scorecard'),
    supabase.rpc('founder_r3579_parameter_verdict_matrix'),
    supabase.rpc('founder_r3579_monthly_accuracy_trend'),
    supabase.rpc('founder_r3579_capa_status_board'),
    supabase.rpc('founder_r3579_root_cause_pareto'),
    supabase.rpc('founder_r3579_accuracy_impact_digest'),
    supabase.rpc('founder_r3579_high_risk_queue'),
  ]);
  ...
  return (
    <main style={{ padding: '2rem', maxWidth: 1400, margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>
        Cochlear-Implant Programming / Audiology QC Audit
      </h1>
      <p style={{ color: '#555', marginBottom: '2rem' }}>
        Hospital cochlear-implant programming &amp; audiology station QC log — parameter (electrode
        impedance kΩ, stim output level, telemetry link, threshold &amp; comfort levels, programming
        accuracy) &times; device model &times; reference vs measured value &times; deviation %
        &times; tolerance band &times; calibration date &amp; CAPA closure. Founder-gated view: QC
