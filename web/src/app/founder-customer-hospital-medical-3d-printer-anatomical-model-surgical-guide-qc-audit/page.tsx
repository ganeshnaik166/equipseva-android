...
export default async function Page() {
  ...
  const [
    ...
    supabase.rpc('founder_r3515_qc_verdict_rollup'),
    supabase.rpc('founder_r3515_device_model_scorecard'),
    supabase.rpc('founder_r3515_parameter_verdict_matrix'),
    supabase.rpc('founder_r3515_monthly_accuracy_trend'),
    supabase.rpc('founder_r3515_capa_status_board'),
    supabase.rpc('founder_r3515_root_cause_pareto'),
    supabase.rpc('founder_r3515_accuracy_impact_digest'),
    supabase.rpc('founder_r3515_high_risk_queue'),
  ]);
  ...
  return (
    <main style={{ padding: '2rem', maxWidth: 1400, margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>
        Medical 3D-Printer (Anatomical-Model / Surgical-Guide) QC Audit
      </h1>
      <p style={{ color: '#555', marginBottom: '2rem' }}>
        Hospital medical 3D-printer QA log for anatomical models &amp; surgical guides — parameter
        (dimensional accuracy mm, layer resolution &micro;m, XY accuracy mm, build repeatability,
        material density, warpage mm) &times; print technology (SLA, DLP, FDM, SLS, material-jetting,
        PolyJet) &times; reference &amp; measured value &times; deviation % &times; tolerance band
