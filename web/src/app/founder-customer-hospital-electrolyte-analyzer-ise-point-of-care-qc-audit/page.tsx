...
export default async function Page() {
  ...
  const [
    ...
    supabase.rpc('founder_r3462_qc_verdict_rollup'),
    supabase.rpc('founder_r3462_device_model_scorecard'),
    supabase.rpc('founder_r3462_parameter_verdict_matrix'),
    supabase.rpc('founder_r3462_monthly_accuracy_trend'),
    supabase.rpc('founder_r3462_capa_status_board'),
    supabase.rpc('founder_r3462_root_cause_pareto'),
    supabase.rpc('founder_r3462_accuracy_impact_digest'),
    supabase.rpc('founder_r3462_high_risk_queue'),
  ]);
  ...
  return (
    <main style={{ padding: '2rem', maxWidth: 1400, margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>
        Electrolyte Analyzer (ISE) Point-of-Care QC Audit
      </h1>
      <p style={{ color: '#555', marginBottom: '2rem' }}>
        Hospital electrolyte analyzer QA log for ion-selective-electrode (ISE) point-of-care QC &mdash;
        device model &times; parameter (sodium, potassium, chloride, ionised calcium, pH &amp; ISE slope
        mV) &times; QC level &times; reference vs measured &times; deviation % &times; tolerance &times;
        calibration currency &amp; CAPA closure. Founder-gated view: QC verdicts, device-model scorecards,
        parameter &times; verdict matrix, root-cause pareto, and accuracy-impact digest across NABL &amp;
        NABH surfaces.
      </p>
