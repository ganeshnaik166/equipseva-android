...
export default async function Page() {
  ...
  const [
    ...
    supabase.rpc('founder_r3575_qc_verdict_rollup'),
    supabase.rpc('founder_r3575_device_model_scorecard'),
    supabase.rpc('founder_r3575_parameter_verdict_matrix'),
    supabase.rpc('founder_r3575_monthly_calibration_trend'),
    supabase.rpc('founder_r3575_capa_status_board'),
    supabase.rpc('founder_r3575_root_cause_pareto'),
    supabase.rpc('founder_r3575_accuracy_impact_digest'),
    supabase.rpc('founder_r3575_high_risk_queue'),
  ]);
  ...
  return (
    <main style={{ padding: '2rem', maxWidth: 1400, margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>
        Posturography / Vestibular Balance-Platform QC Audit
      </h1>
      <p style={{ color: '#555', marginBottom: '2rem' }}>
        Computerized dynamic posturography &amp; vestibular balance-platform QA log — parameter
        (force-plate accuracy, sway measurement, platform tilt&deg;, visual-surround sync, load
        linearity, motor response ms) &times; reference &times; measured &times; deviation %
        &times; tolerance &times; verdict &amp; CAPA closure. Founder-gated view: QC verdicts,
        device-model scorecards, parameter &times; verdict matrix, monthly calibration/accuracy
        trend, root-cause pareto, and accuracy-impact digest across NABH &amp; CDSCO surfaces.
      </p>
