...
export default async function Page() {
  ...
  const [
    ...
    supabase.rpc('founder_r3562_qc_verdict_rollup'),
    supabase.rpc('founder_r3562_device_model_scorecard'),
    supabase.rpc('founder_r3562_parameter_verdict_matrix'),
    supabase.rpc('founder_r3562_monthly_accuracy_trend'),
    supabase.rpc('founder_r3562_capa_status_board'),
    supabase.rpc('founder_r3562_root_cause_pareto'),
    supabase.rpc('founder_r3562_accuracy_impact_digest'),
    supabase.rpc('founder_r3562_high_risk_queue'),
  ]);
  ...
  return (
    <main style={{ padding: '2rem', maxWidth: 1400, margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>
        Radiofrequency-Ablation (RFA) Generator QC Audit
      </h1>
      <p style={{ color: '#555', marginBottom: '2rem' }}>
        Hospital RFA generator QC log — parameter (set power, delivered power, impedance &#8486;, tip
        temperature, ablation timer &amp; energy deviation) &times; reference vs measured &times;
        deviation % &times; tolerance band &times; calibration currency &times; verdict &amp; CAPA
        closure. Founder-gated view: QC verdicts, device-model scorecards, parameter &times; verdict
        matrix, root-cause pareto, and accuracy-impact digest across NABH &amp; CDSCO surfaces.
      </p>
