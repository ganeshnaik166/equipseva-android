...
export default async function Page() {
  ...
  const [
    ...
    supabase.rpc('founder_r3546_qc_verdict_rollup'),
    supabase.rpc('founder_r3546_device_model_scorecard'),
    supabase.rpc('founder_r3546_parameter_verdict_matrix'),
    supabase.rpc('founder_r3546_monthly_calibration_trend'),
    supabase.rpc('founder_r3546_capa_status_board'),
    supabase.rpc('founder_r3546_root_cause_pareto'),
    supabase.rpc('founder_r3546_accuracy_impact_digest'),
    supabase.rpc('founder_r3546_high_risk_queue'),
  ]);
  ...
  return (
    <main style={{ padding: '2rem', maxWidth: 1400, margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>
        Hysteroscope (Gynecology Endoscope) QC Audit
      </h1>
      <p style={{ color: '#555', marginBottom: '2rem' }}>
        Hospital hysteroscope imaging &amp; fluid-management QA log — device model (Karl Storz Hopkins II,
        Olympus HYF-XP &amp; OTV-S190, Stryker 1288 HD, Richard Wolf Panoview) &times; QC parameter (image
        resolution, light transmission, viewing angle, fluid flow, color fidelity, seal-leak test) &times;
        reference vs measured value &times; deviation % &times; tolerance &times; calibration accuracy trend
