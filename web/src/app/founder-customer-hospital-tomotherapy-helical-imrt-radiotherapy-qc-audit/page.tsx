...
export default async function Page() {
  ...
  const [
    ...
    supabase.rpc('founder_r3587_qc_verdict_rollup'),
    supabase.rpc('founder_r3587_device_model_scorecard'),
    supabase.rpc('founder_r3587_parameter_verdict_matrix'),
    supabase.rpc('founder_r3587_monthly_calibration_trend'),
    supabase.rpc('founder_r3587_capa_status_board'),
    supabase.rpc('founder_r3587_root_cause_pareto'),
    supabase.rpc('founder_r3587_accuracy_impact_digest'),
    supabase.rpc('founder_r3587_high_risk_queue'),
  ]);
  ...
  return (
    <main style={{ padding: '2rem', maxWidth: 1400, margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>
        TomoTherapy Helical IMRT QC Audit
      </h1>
      <p style={{ color: '#555', marginBottom: '2rem' }}>
        Hospital TomoTherapy helical IMRT quality-control log — device model (Radixact X9 &amp; X7,
        TomoTherapy HD &amp; HDA) &times; QC parameter (output constancy, gantry rotation accuracy,
        couch speed accuracy, MLC leaf timing, beam-sync accuracy, red-green laser alignment) &times;
        reference vs measured value &times; deviation % &times; tolerance band &times; within-tolerance
        &amp; CAPA closure. Founder-gated view: QC verdicts, device-model scorecards, root-cause
        pareto, and accuracy-impact digest across AERB &amp; NABH regulatory surfaces.
      </p>
