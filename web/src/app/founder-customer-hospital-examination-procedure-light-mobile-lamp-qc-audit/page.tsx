...
export default async function Page() {
  ...
  const [
    ...
    supabase.rpc('founder_r3506_qc_verdict_rollup'),
    supabase.rpc('founder_r3506_device_model_scorecard'),
    supabase.rpc('founder_r3506_parameter_verdict_matrix'),
    supabase.rpc('founder_r3506_monthly_accuracy_trend'),
    supabase.rpc('founder_r3506_capa_status_board'),
    supabase.rpc('founder_r3506_root_cause_pareto'),
    supabase.rpc('founder_r3506_accuracy_impact_digest'),
    supabase.rpc('founder_r3506_high_risk_queue'),
  ]);
  ...
  return (
    <main style={{ padding: '2rem', maxWidth: 1400, margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>
        Examination / Procedure Light (Mobile Lamp) QC Audit
      </h1>
      <p style={{ color: '#555', marginBottom: '2rem' }}>
        Mobile examination &amp; procedure lamp photometric QA log — device model &times; department
        &times; light source (LED, halogen, hybrid, xenon) &times; parameter (illuminance lux, colour
        temperature K, CRI index, focus-field diameter cm, battery runtime min, flicker %) &times;
        reference vs measured value &times; deviation % &times; tolerance &amp; CAPA closure.
