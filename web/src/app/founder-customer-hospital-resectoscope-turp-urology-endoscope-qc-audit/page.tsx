...
export default async function Page() {
  ...
  const [
    ...
    supabase.rpc('founder_r3554_qc_verdict_rollup'),
    supabase.rpc('founder_r3554_device_model_scorecard'),
    supabase.rpc('founder_r3554_parameter_verdict_matrix'),
    supabase.rpc('founder_r3554_monthly_accuracy_trend'),
    supabase.rpc('founder_r3554_capa_status_board'),
    supabase.rpc('founder_r3554_root_cause_pareto'),
    supabase.rpc('founder_r3554_accuracy_impact_digest'),
    supabase.rpc('founder_r3554_high_risk_queue'),
  ]);
  ...
  return (
    <main style={{ padding: '2rem', maxWidth: 1400, margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>
        Resectoscope (TURP Urology Endoscope) QC Audit
      </h1>
      <p style={{ color: '#555', marginBottom: '2rem' }}>
        Resectoscope (TURP urology endoscope) QC log — parameter (image resolution, HF cutting-loop
        current, light transmission, irrigation flow, viewing angle &amp; seal leak test) &times;
        ...
        scorecards, root-cause pareto, and accuracy-impact digest across NABH &amp; CDSCO surfaces.
      </p>
