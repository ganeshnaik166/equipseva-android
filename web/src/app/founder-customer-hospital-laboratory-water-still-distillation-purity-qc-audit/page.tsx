...
export default async function Page() {
  ...
  const [
    ...
    supabase.rpc('founder_r3491_qc_verdict_rollup'),
    supabase.rpc('founder_r3491_device_model_scorecard'),
    supabase.rpc('founder_r3491_parameter_verdict_matrix'),
    supabase.rpc('founder_r3491_monthly_qc_trend'),
    supabase.rpc('founder_r3491_capa_status_board'),
    supabase.rpc('founder_r3491_root_cause_pareto'),
    supabase.rpc('founder_r3491_accuracy_impact_digest'),
    supabase.rpc('founder_r3491_high_risk_queue'),
  ]);
  ...
  return (
    <main style={{ padding: '2rem', maxWidth: 1400, margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>
        Laboratory Water-Still / Distillation Purity QC Audit
      </h1>
      <p style={{ color: '#555', marginBottom: '2rem' }}>
        Hospital laboratory water-still / distillation-unit purity QC log — parameter (conductivity
        &micro;S, resistivity M&Omega;, TOC ppb, output rate L/h, pH, bacterial CFU) &times; measured
        vs reference &times; deviation % &times; within-tolerance &times; calibration currency &times;
        sample point &amp; CAPA closure. Founder-gated view: QC verdicts, device-model scorecards,
        parameter &times; verdict matrix, monthly accuracy trend, root-cause pareto, and
